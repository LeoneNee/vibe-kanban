...
export function TaskBrainstormLaunch() {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    await createWorkspace.mutateAsync({
      task: {
        ...
        title: `🧠 Brainstorm: ${task?.title || title}`,
        description,
        status: null,
        task_type: 'task',
  ...
  // Handle case where task is loading
  if (isTaskLoading) {
    return (
      <div className="flex h-full w-full items-center justify-center">
        <div className="text-center max-w-md">
          <div className="mx-auto w-8 h-8 animate-spin rounded-full border-4 border-muted border-t-primary mb-4" />
  ...
  if (!task && !isTaskLoading) {
    return (
      <div className="flex h-full w-full items-center justify-center">
        <div className="text-center max-w-md">
          <h2 className="text-lg font-medium text-high mb-2">Task not found</h2>
        ...
        <div className="w-full max-w-2xl space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  AI-assisted requirement clarification for {task?.title}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg bg-muted/50 border border-border/50 p-4">
            ...
            <ol className="text-sm text-muted-foreground space-y-1.5 list-decimal list-inside">
              <li>AI will ask 2-3 key questions to clarify task requirements</li>
              <li>Answer questions to help AI understand what you need</li>
              <li>Review the generated requirement summary</li>
              <li>Save refined requirements back to the task</li>
            </ol>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-border bg-background">
              <textarea
                ...
                placeholder="Task details and requirements will be pre-filled..."
