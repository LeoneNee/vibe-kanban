...
export type DocSection = "api_spec" | "test_cases" | "dependencies" | "changelog" | "implementation_hints";

export type UpdateTaskDocInput = { section: DocSection, content: string, };
